const calcColorLanguage = (language) => {
    if (language === "Python" || language === "TypeScript")
        ...
        return "blueIcon";
    else if (language === "Vue" || language === "C#")
        return "blueIcon";
...
export const IconRepositories = () => (<i className="bi bi-journal-bookmark"></i>);
...
export const IconLanguage = (language) => (<i className={`bi bi-circle-fill languageIcon ${calcColorLanguage(language)}`}></i>);
