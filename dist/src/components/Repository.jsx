...
language, nForks, lastUpdate, }) => {
    return (<div className="flex flex-col">
      <div className="flex flex-row justify-between mb-2 md:mb-1">
        ...
        <Button label="Star" icon="IconStar" onClick={() => console.log("Star still not implemented")} iconFirst={true}/>
      </div>
      <p className="text-xs mb-2">{description}</p>
      <div className="flex flex-row space-x-4 text-[10px] text-slate-600">
        {language ? (<div className="flex flex-row">
